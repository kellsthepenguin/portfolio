...
export default function Techs() {
  return (
    <div className='snap-start w-screen h-screen'>
      <div className='text-center sm:text-left p-24 sm:text-4xl text-2xl font-light'>
        <p className='mb-2'>저는 이러한 기술들을 사용할 수 있습니다.</p> 
        <div className='flex flex-row max-sm:justify-center gap-3 flex-wrap xl:w-[calc((24rem+12px)*3)]'>
